...
import { addjob } from "../store/Api.js";
import { AddMessage } from "../utils/constants/JobConstant.js";
...
export default function AddJobPage() {
  ...
  const onSubmitJob = async (event) => {
    ...
    const toastID = toast.loading(AddMessage.LOADING);
    const response = await addjob(form.fields);

    if (response.success) {
      toast.update(toastID, {
        render: AddMessage.SUCCESS,
        type: "success",
        isLoading: false,
        autoClose: true
      });
